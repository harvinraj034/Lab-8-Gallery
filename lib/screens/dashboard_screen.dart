...
import 'package:gallery_lab/screens/AddImage.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ThemeChanger  _lightTheme = _themeChanger.setTheme(ThemeData.dark());
    // ThemeChanger  _darkTheme = _themeChanger.setTheme(ThemeData.light());
